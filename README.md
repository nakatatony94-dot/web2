...
注意事项
要点说明id 必须一致两个文件的 id / 键名完全相同，否则详情页显示"资料整理中..."用反引号 `bio、bioDetail、长文本字段都用反引号，避免中文引号引发语法错误照片放对位置图片放在 images/portraits/ 文件夹下，photo 填相对路径著作有文件可下载file 填相对路径如 "files/burke_reflections.pdf"，无文件填 null添加完保存即生效Live Server 会自动刷新，无需重启NO SCRIPTS
